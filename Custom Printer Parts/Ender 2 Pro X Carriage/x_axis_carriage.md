...
Here is the break down of each component and relevant measurements:
  ...
  - The forks are bent 90 degrees from the rest of the plate and have a matching length of 20.38mm. Both forks have slots that go from their top edge to where the gap ends. The top edge is open.
  ...
  - There is a cutout rectangle with rounded edges. It is 22.00mm by 14.00mm and is 23mm from the left side of the plate. It is 28.60mm from the top of the plate.
  ...
  - There are two 5.20mm holes used to hold the two V-Wheels at the top of the plate. The left hole is 9.45mm from the left edge of the plate and the right hole is 9.45mm from the right edge of the plate. They are both 9.30mm from the top of each hole to the top edge of the plate.
